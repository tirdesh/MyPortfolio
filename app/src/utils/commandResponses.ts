...
export const commandResponses = {
  ...
  about: `Let me take you on a little journey! 🌟 I'm Tirdesh Pettugani, a software developer with a heart full of passion for creating interactive web experiences. My adventure began at Northeastern University, where I earned a Master of Science in Information Systems. I spent over four years at Commvault Systems, then worked through a co-op and a research role before landing my current job as a Microsoft 365 Copilot Engineer at Wave Life Sciences. If you're curious about the twists and turns of my journey, just let me know!`,

  education: `Ah, education—the foundation of my story! 🎓 I studied at Northeastern University in Boston, graduating in December 2025 with a Master of Science in Information Systems. My academic journey has been filled with exploration, maintaining a GPA of 3.7/4 while diving into courses like Web Design and User Experience, and Program Structures and Algorithms. Each course has added a new layer to my understanding of technology. Want to hear how this knowledge has shaped my projects?`,
